...
struct GetJointPoseResponse_
{
  ...
  GetJointPoseResponse_(const ContainerAllocator& _alloc)
    : position_ctrl_joint_pos(_alloc)  {
  (void)_alloc;
    }



   typedef  ::open_manipulator_msgs::JointPose_<ContainerAllocator>  _position_ctrl_joint_pos_type;
  _position_ctrl_joint_pos_type position_ctrl_joint_pos;
...
// {'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'open_manipulator_msgs': ['/home/rasmus/catkin_ws/src/open_manipulator/open_manipulator_msgs/msg']}
...
struct MD5Sum< ::open_manipulator_msgs::GetJointPoseResponse_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x7204b88d723dcb9dULL;
  static const uint64_t static_value2 = 0xffcbfeacbf4044c2ULL;
};
...
struct Definition< ::open_manipulator_msgs::GetJointPoseResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "JointPose position_ctrl_joint_pos\n\
\n\
\n\
================================================================================\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::open_manipulator_msgs::GetJointPoseResponse_<ContainerAllocator> >
  {
    ...
    {
      stream.next(m.position_ctrl_joint_pos);
    }
...
struct Printer< ::open_manipulator_msgs::GetJointPoseResponse_<ContainerAllocator> >
{
  ...
  {
    s << indent << "position_ctrl_joint_pos: ";
    s << std::endl;
    Printer< ::open_manipulator_msgs::JointPose_<ContainerAllocator> >::stream(s, indent + "  ", v.position_ctrl_joint_pos);
  }
};
