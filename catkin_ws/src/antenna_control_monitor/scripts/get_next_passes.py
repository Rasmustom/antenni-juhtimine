...
def getNextPasses(passes):
	...
	open('/home/rasmus/catkin_ws/src/antenna_control_monitor/scripts/next_passes.txt', 'w').close()
	with open('/home/rasmus/catkin_ws/src/antenna_control_monitor/scripts/next_passes.txt', 'a') as f:
